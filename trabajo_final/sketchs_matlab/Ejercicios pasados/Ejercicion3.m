...
% syms t;
% 
% v1=constantes(1)*autovec(1,1)*exp(autoval(1)*t)+constantes(2)*autovec(1,2)*exp(autoval(2)*t);
% v2=constantes(1)*autovec(2,1)*exp(autoval(1)*t)+constantes(2)*autovec(2,2)*exp(autoval(2)*t);
% v3=v1+v2;
% 
% pretty(v1)
% pretty(v2)
...
for i= ti:h:tf
   ...
   %Acá comienza el método 
    ...
    %Al tener un loop de capacitores
