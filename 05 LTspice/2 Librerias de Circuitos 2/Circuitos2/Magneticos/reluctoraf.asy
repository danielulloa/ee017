...
TEXT -40 -10 Left 2 A
TEXT -39 11 Left 2 F
TEXT -97 33 Left 1 Rel
WINDOW 3 -127 4 Center 2
WINDOW 0 -151 -28 Left 2
SYMATTR Value Lr=L1 Ar=A1
SYMATTR Description Reluctor no lineal de ACERO DE FUNDICIÓN mediante la aproximación de Brauer. Proporciona los valores de B y H en su punto de trabajo. ATENCIÓN: Ingresar L en cm y A en cm^2
SYMATTR ModelFile ..\sym\Circuitos2\Magneticos\magneticos.lib
SYMATTR Prefix X
SYMATTR SpiceModel reluctorbr
SYMATTR Value2 k1=23.889 k2=1.8101 k3=593.2461
PIN -32 -64 NONE 8
PINATTR PinName 1
