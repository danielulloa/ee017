...
la impedancia es la negativa del elemento Z. Entonces se puede representar el circuito de la siguiente manera:
...
\begin{equation}
    ...
    \begin{itemize} 
    	...
    	\item $\tau$
    \end{itemize}
       La posición de los polos está determinada por el factor de amortiguamiento, $\xi$. Para obtener la caracteristica de un oscilador los polos deben ser imaginarios puros, por lo tanto 
       $\xi$ debe ser nula. 
    \begin{equation}
        p_{1}=\frac{\xi  (-\tau)-\sqrt{\xi ^2 \tau^2-\tau^2}}{\tau^2} ;p_{2}=\frac{\sqrt{\xi ^2 \tau^2-\tau^2}-\xi  \tau}{\tau^2}
    \end{equation}
...
i(t)=i_{R2}(t)
\end{equation}
Expresando las corrientes en términos .....
\begin{equation}
i(t)=C*V_{c}'(t)
\end{equation} 
\begin{equation}
