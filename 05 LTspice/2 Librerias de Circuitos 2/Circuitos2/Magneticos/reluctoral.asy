...
SYMATTR Description Reluctor no lineal de ACERO LAMINADO mediante la aproximación de Brauer. Proporciona los valores de B y H en su punto de trabajo. ATENCIÓN: Ingresar L en cm y A en cm^2
SYMATTR ModelFile ..\sym\Circuitos2\Magneticos\magneticos.lib
SYMATTR Prefix X
SYMATTR SpiceModel reluctorbr
SYMATTR Value2 k1=3.2351 k2=2.6096 k3=183.0369
PIN -32 -64 NONE 8
PINATTR PinName 1
