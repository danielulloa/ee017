...
%Por inspección el circuito es una configuración RLC serie acompañada de un conversor de impedancias negativas, el cual tiene una impedancia de entrada Z1=V1/I1, Si las resistencias R1 y R2 son iguales, la impedancia de entrada Z1 del circuito es la negativa de Z. Esta impedancia negativa Z compensa las pérdidas de energía en resistencia $R_{1}$ y es por lo tanto un oscilador. 
...
\begin{equation}
    ...
    \end{equation}
    En los sistemas de segundo orden existen tres parámetros a considerar: la ganancia estática,k, el factor de amortiguamiento, $\xi$, y $\tau$ %como se llamaba xD
...
Para la respuesta temporal del oscilador aplicamos la %antitransformada o inversa obteniendo la respuesta al escalón
\begin{equation}
