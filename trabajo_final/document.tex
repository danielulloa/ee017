...
\begin{document}
	...
	En este informe se presentan los conceptos de variables de estado y ecuaciones de estados de un sistema dinámico.\\
	
	Mediante la utilización de métodos numéricos, álgebra lineal y ecuaciones diferenciales se demostrará que es posible representar la solución de un sistema y sus variables de estado y que el uso de la notación matricial simplifica la representación matemática de los sistemas de ecuaciones.\\
