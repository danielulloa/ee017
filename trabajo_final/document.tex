...
\begin{document}
	...
	Éste trabajo se enfoca en encontrar las respuestas temporales a partir de representar circuitos con sus ecuaciones de estado. Para ello es necesario encontrar la solución de Sistemas de Ecuaciones Diferenciales Algebraicas
